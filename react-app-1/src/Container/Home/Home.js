...
.then(data => {
  ...
  setDataComponentDate1('Tomorrow');
...
const time = new Date(dataComponentTime0).toLocaleString('en-EN', options2);
const sunrise = new Date(dataComponentSunrise0).toLocaleString('en-EN', options2);
const sunset = new Date(dataComponentSunset0).toLocaleString('en-EN', options2);
        ...
        <p>
                ...
                <option value="">Select a city</option>
                        ...
                        <optgroup label="Africa">
                                <option value="1532755">Casablanca The Best</option>
                        </optgroup>
